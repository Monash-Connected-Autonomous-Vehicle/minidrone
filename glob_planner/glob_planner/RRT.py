...
class RRTC:##############################################
    ...
    def new_node_is_free(self,new_node,og_width,og_resolution,og_data):
        ...
        og_index = self.map_to_og_conversion(point=new_node,og_width=og_width,og_resolution=og_resolution)
    ...
    def map_to_og_conversion(self,point,og_width,og_resolution):
        """
