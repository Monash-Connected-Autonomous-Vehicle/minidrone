...
def mcav_node_doc(node_class):
    '''
    Decorator for ROS nodes that provides extra functionality for MCAV autodocumentation.

    TODO: Detailed documentation for anyone who may get confused.
    '''
    class MCAVDocNode(node_class, metaclass=NumpyDocstringInheritanceMeta):
